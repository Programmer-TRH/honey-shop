...
export function ProductMedia({ form }: ProductImagesProps) {
  ...
  const removeImage = (index: number) => {
    ...
    setValue("images", newImages); // Adjust primary image index if needed
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardHeader>
            ...
            <CardTitle className="flex items-center space-x-2">
              {" "}
              <Upload className="h-5 w-5" /> <span>Upload Images</span>{" "}
            </CardTitle>{" "}
        ...
        <Card>
          ...
          <CardHeader>
            ...
            <CardTitle className="flex items-center space-x-2">
              {" "}
              <LinkIcon className="h-5 w-5" /> <span>Add from URL</span>{" "}
            </CardTitle>{" "}
        ...
        <Card className="border-dashed border-2 border-gray-300">
          ...
          <CardContent className="pt-6">
            ...
            <div className="text-center py-8">
              ...
              >
                {" "}
                <Upload className="h-4 w-4 mr-2" /> Upload Your First Image{" "}
              </Button>{" "}
            </div>{" "}
          </CardContent>{" "}
        </Card>
