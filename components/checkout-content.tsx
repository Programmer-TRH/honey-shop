...
import { CheckCircle, Truck, Shield, CreditCard, Banknote, ArrowLeft, Loader2 } from "lucide-react"
import Link from "next/link"
import { getCart } from "@/lib/actions/cart-actions"
import { placeOrder, type OrderData } from "@/lib/actions/checkout-actions"
  ...
  if (cartItems.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-muted-foreground mb-8">Add some delicious honey to your cart before checking out.</p>
              ...
              <CardContent className="space-y-6">
                ...
                {paymentMethod === "cod" && (
                  <div className="bg-muted/30 p-4 rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Cash on Delivery Instructions</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• Please keep exact change ready</li>
                      <li>• Our delivery person will call before arrival</li>
                      <li>• Delivery usually takes 1-2 business days in Dhaka</li>
                    ...
                    {formData.notes && (
                      <div className="mt-2 pt-2 border-t border-border">
                        <p className="text-muted-foreground">
                          <strong>Special Instructions:</strong> {formData.notes}
                        </p>
                      </div>
                    )}
                  </div>
