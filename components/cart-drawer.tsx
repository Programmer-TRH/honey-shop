...
import { getCart, updateCartItem, removeFromCart, type Cart } from "@/lib/actions/cart-actions"
...
export function CartDrawer({ initialCart }: CartDrawerProps) {
  const [cart, setCart] = useState<Cart>(initialCart || { items: [], total: 0, itemCount: 0 })
      ...
      <SheetContent className="w-full sm:max-w-lg">
        ...
        {cart.items.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">Add some delicious honey to get started!</p>
