...
export function ReviewForm({ productId, onReviewSubmitted }: ReviewFormProps) {
  ...
  return (
    <Card className="border-border/50">
      <CardHeader>
        <CardTitle className="text-lg font-semibold text-foreground">Write a Review</CardTitle>
      </CardHeader>
      <CardContent>
        <form id="review-form" action={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="title" name="title" placeholder="Summarize your experience" required className="bg-background" />
          </div>
