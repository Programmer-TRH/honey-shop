  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-1/2 hidden lg:block">
        <img
          src="/golden-honey-jar-with-honeycomb-background-natural.jpg"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl lg:max-w-xl">
          <div className="flex flex-wrap items-center gap-3 mb-8">
            <Badge
              variant="secondary"
              className="bg-primary/15 text-primary border-primary/30 px-4 py-2 text-sm font-medium"
            >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-pretty leading-relaxed">
            From Sundarbans to your table - Experience nature's golden treasure with
            <span className="text-primary font-semibold"> guaranteed purity</span> and
            <span className="text-primary font-semibold"> authentic taste</span>.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Button asChild size="lg" className="text-lg px-10 py-4 shadow-lg hover:shadow-xl transition-all group">
              <Link href="/shop">
            ...
            <Button variant="outline" size="lg" className="text-lg px-8 py-4 bg-white/90 hover:bg-white border-2 group">
          ...
          <div className="flex flex-wrap items-center gap-8 text-center sm:text-left">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">In Dhaka</p>
              </div>
            </div>
