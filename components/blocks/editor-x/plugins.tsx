...
export function Plugins({ placeholder }: { placeholder?: string | undefined }) {
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-[5] flex items-center gap-2 overflow-auto border-b p-1">
