...
import { Star, Shield, Truck, Award, Heart, Plus, Minus, ShoppingCart } from "lucide-react"
import Link from "next/link"
import { ProductReviews } from "@/components/product-reviews"
import { addToCart } from "@/lib/actions/cart-actions"
import { addToWishlist, removeFromWishlist, isInWishlist } from "@/lib/actions/wishlist-actions"
import { getProductReviews, type Product } from "@/lib/actions/data-actions"
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h1 className="font-serif text-3xl font-bold text-foreground mb-2 text-balance">{product.name}</h1>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="flex items-center space-x-2 p-3 bg-muted/30 rounded-lg">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">100% Pure</p>
            ...
            <div className="flex items-center space-x-2 p-3 bg-muted/30 rounded-lg">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">COD Available</p>
          ...
          <p className="text-sm text-muted-foreground">
            Free delivery in Dhaka • Cash on Delivery available • 100% satisfaction guarantee
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="description" className="w-full">
        ...
        <TabsContent value="description" className="mt-6">
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold text-lg text-foreground mb-4">Product Description</h3>
              <p className="text-muted-foreground leading-relaxed mb-6">{product.description}</p>

              <h4 className="font-semibold text-foreground mb-3">Health Benefits</h4>
        ...
        <TabsContent value="nutrition" className="mt-6">
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold text-lg text-foreground mb-4">Nutritional Information</h3>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                * Values are approximate and may vary based on natural variations in honey composition.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
