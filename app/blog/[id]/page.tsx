...
import { getBlogPost, getRelatedBlogPosts } from "@/lib/actions/data-actions"
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="space-y-8">
            <header className="space-y-6">
              ...
              <h1 className="font-serif text-3xl md:text-4xl font-bold text-foreground text-balance">{post.title}</h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="text-lg leading-relaxed space-y-4">{formatContent(post.content)}</div>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Expert in natural health and wellness, specializing in the therapeutic benefits of honey and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {relatedPosts.map((relatedPost) => (
                <Card key={relatedPost.id} className="group hover:shadow-lg transition-all duration-300">
                  <div className="relative">
                    <img
                      src={relatedPost.image || `/placeholder.svg?height=200&width=400&query=${relatedPost.title}`}
