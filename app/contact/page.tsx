          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground text-pretty max-w-2xl mx-auto mb-8">
                Have questions about our honey? Our dedicated team is ready to assist you in finding the perfect natural
                sweetness for your family.
              </p>

              <div className="flex justify-center items-center space-x-2 text-muted-foreground">
                <Clock className="h-4 w-4" />
                <span className="text-sm">Average response time: Under 2 hours</span>
              </div>
            </div>
